...
trace = sample(model, NUTS(Nmcmc, 0.85; adtype=AutoMooncake(; config=nothing)), MCMCDistributed(), Nmcmc, Nchain) #, initial_params=map_point.values.array)
...
to_netcdf(chain, joinpath(@__DIR__, "..", "data", "J0740_varying_background_fourier.nc"))
